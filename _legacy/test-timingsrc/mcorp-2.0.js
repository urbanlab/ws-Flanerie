...
var MSV = (function (_MSV_) {
    ...
    var HTTPRequest = (function () {
        ...
        var makeRequest = function (_options) {
            console.log("HTTPRequest: makeRequest", _options);
            var self = {};
            var buf = [];
            var result_handler;
            var reqid = counter++;
            ...
            var send = function (url, msg) {
                ...
                console.log("HTTPRequest: Send", url, msg);
    ...
    var makeHTTPConnection = function (master_url) {
        console.log("makeHTTPConnection", master_url);
        var self = {};
        var _onopen = null;
        var _onerror = null;
        var _onmessage = null;
    ...
    var makeWSConnection = function (url) {
        console.log("makeWSConnection", url);
        var self = {};
        var conn;
        var _onmessage;
        var _onopen;
        ...
        var handle_message = function (event) {
            if (_onmessage) {
                console.log("WS: handle_message", event.data);
    ...
    var IORemote = function (host, options) {
        console.log("IORemote", host, options);
        var self = {};
        options = options || {};
        var Delay = { CONNECT: options["to-connect"] || 5, RECONNECT: options["to-reconnect"] || 10, PING: options["to-ping"] || 10 };
    ...
    var makeMsvDB = function () {
        ...
        var update_msvs = function (msv_data_list) {
            ...
            for (var i = 0; i < msv_data_list.length; i++) {
                ...
                var new_msv_data = { msvid: msvid, eventid: old_msv_data.eventid + 1, old_vector: old_vector, now_vector: now_vector, vector: [p, v, a, ts_now], range: old_msv_data.range };
    ...
    var IOLocal = function () {
        ...
        var send = function (msg) {
            ...
            if (msg.cmd == MsvCmd.UPDATE) {
                response = { type: MsgType.RESPONSE, cmd: MsvCmd.UPDATE, tunnel: msg.tunnel || null, data: process_update(msg.data) };
                ...
                response = { type: MsgType.RESPONSE, cmd: MsvCmd.CREATE, tunnel: msg.tunnel || null, data: db.create_msvs(msg.data) };
                output(response);
            }
            return true;
        };
...
var MSV = (function (_MSV_) {
    ...
    var tokenManager = function (timeoutHandler) {
        ...
        return { refreshToken: refreshToken, confirmToken: confirmToken, getToken: getToken, getMsvidListByToken: getMsvidListByToken, isConfirmed: isConfirmed, sortByToken: sortByToken };
    };
    var msvclient = function (io, token, options) {

        console.log("msvclient", io, token, options);
        var api_public = {};
        var api_proxy = {};
        var api_request = {};
        var _tokenManager;
        ...
        var onmessage = function (msg) {
            console.log("msvclient onmessage", msg);
    ...
    var STATE = Object.freeze({ INIT: "init", CONNECTING: "connecting", EXPIRED: "expired", OPEN: "open", CLOSED: "closed" });
    var msvproxy = function (msvclient, msvid) {
        ...
        var getState = function () {
            return isValid()
                ...
                : { readyState: readystate.get(), latency: msvclient.get_latency(), skew: msvclient.get_skew(), connType: msvclient.conn_type(), src: msvclient.get_url(msvid) };
        };
...
var MCorp = (function (_mcorp_) {
    ...
    var app = function (appid, options) {
        ...
        if (options.profile) {
            setTimeout(function () {
                ...
                console.log('SEND= report_stats', url, params)
        ...
        var request_context = function (msvlist, onSuccess) {
            ...
            var onResult = function (result) {
                console.log("RES= request_context", result);
            ...
            console.log('REQ= request_context', url, params)
        ...
        var request_groupcontext = function (sid) {
            ...
            var onResult = function (result) {
                console.log("RES= request_groupcontext", result);
            ...
            console.log('REQ= request_groupcontext', url, params)
        ...
        var get_association = function (key, onSuccess, onError) {
            ...
            console.log('REQ= get_association', url, params)
        ...
        var set_association = function (key, value, onSuccess, onError) {
            ...
            console.log('REQ= set_association', url, params)
            JSONP.get(url, params, onSuccess, onError);
        };
        ...
        var get_session = function (onSuccess, onError) {
            ...
            console.log('REQ= get_session', url, params)
            JSONP.get(url, params, onSuccess, onError);
        };
        var msvs_left;
        var profile_start;
        ...
        self.create_global_motion = function (nick, mode) {
            return new Promise(function (resolve, reject) {
                ...
                console.log('REQ= create_msv', url, params)
                JSONP.get(
                    url,
                    params,
                    function (response) {
                        console.log("RES= create_msv", response);
        ...
        self.create_user_motion = function (nick, onSuccess, onError, mode) {
            return new Promise(function (resolve, reject) {
                ...
                console.log('REQ= add_msv_template', url, params)
                JSONP.get(
                    url,
                    params,
                    function (response) {
                        console.log("RES= add_msv_template", response);
                        if (response.result != "success") {
                            reject(response);
                        } else {
                            self.get_motions([nick]).then(resolve).catch(reject);
        ...
        var schedule_token_refresh = function (url, params, retry) {
            ...
            var ts_cs, ts_cr;
            var onResult = function (result) {
                console.log("RES= schedule_token_refresh", result);
                outstanding--;
                ts_cr = new Date().getTime();
                set_token(result, ts_cs, ts_cr);
            ...
            setTimeout(function () {
                ...
                try {
                    console.log('REQ= schedule_token_refresh', url, params)
                    JSONP.get(url, params, onResult, onError);
                } catch (err) {
                    onError(err);
                }
        ...
        var cast_url = function (url, onSuccess, onError) {
            ...
            cast_session.sendMessage(
                "urn:x-cast:no.mcorp.castinmotion",
                { url: url || options.castURL, session: session },
                function (res) {
                    isBusy = true;
    ...
    var request_user_info = function (onSuccess, onError) {
        ...
        var onResult = function (result) {
            console.log("RES= request_user_info", result);
            if (result.error === "signin") {
                window.location = result.url;
                return;
            }
        ...
        console.log('REQ= request_user_info', url, { referrer: window.location.href })
    ...
    var attribution = function (target, animate, nosync) {
        ...
        if (animate) {
            ...
            logo_app.run = function () {
                ...
                e.innerHTML +=
                    "<div class='stripe_container' id='m_cont' style='width:252px;height:1px;overflow:hidden;position:relative'><div class='stripe' id='m_stripe' style='height:1px;width:400px;background:orange;position:absolute;left:-400px'></div></div>";
        ...
        e.innerHTML =
            ...
            "<div id='text' style='" +
            style +
            "'>Motion Corporation</div><div class='stripe_container' id='m_cont' style='width:252px;height:1px;overflow:hidden;position:relative'><div class='stripe' id='m_stripe' style='height:1px;width:400px;background:orange;position:absolute;left:-400px'></div></div>";
        target.appendChild(e);
    };
    _mcorp_.app = app;
